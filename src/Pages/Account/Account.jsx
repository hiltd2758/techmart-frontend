...
const Account = () => {  
  ...
  const orders = [  
    {  
      ...
      total: 5499,  
      items: [  
        { name: 'MacBook Pro 16" M3 Max', quantity: 1, price: 5499, image: '/arrivals/arrival_1.jpg' }  
      ]  
    },  
    {  
      id: 'ORD-002',   
      ...
      total: 1299,  
      items: [  
        { name: 'iPhone 15 Pro', quantity: 1, price: 1299, image: '/arrivals/arrival_3.png' }  
      ]  
    },
    {  
      id: 'ORD-003',   
      ...
      total: 749,  
      items: [  
        { name: 'AirPods Pro Gen 2', quantity: 3, price: 249, image: '/arrivals/arrival_4.jpg' }  
      ]  
    }  
  ];  
          ...
          >  
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">  
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">  
                <span className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold border-2 ${statusConfig.bgColor} ${statusConfig.textColor} ${statusConfig.borderColor}`}>  
            ...
            <div className="flex flex-wrap gap-3">
              <button className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-gray-900 to-gray-800 text-white font-poppins font-semibold rounded-xl hover:from-gray-800 hover:to-gray-700 transition-all duration-300 shadow-md hover:shadow-lg">  
                <FaEye />
                View Details  
              </button> 
          ...
          >  
            ...
            <div className="space-y-2 text-sm text-gray-600 mb-6 pl-1">  
              ...
              <p className="flex items-start gap-2">
                ...
                <span className="font-medium">{address.city}, {address.state} {address.zip}</span>
              </p>  
              <p className="flex items-start gap-2">
  ...
  return (  
    <>
    <HomeNavbar />
    <div className="w-full bg-gradient-to-b from-gray-50 to-white pt-[140px] pb-20 min-h-screen">  
