...
const AddCountry = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert("Failed to create country. Please check the inputs.");
        } finally {
            setLoading(false);
        }
    };
                ...
                <div className="flex items-end justify-between pb-6 border-b border-neutral-200">
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h1 className="text-3xl font-light tracking-tight text-neutral-900">Add New Country</h1>
                        </div>
                        <p className="text-neutral-500 mt-1 text-sm font-mono">Create a new country region</p>
                    </div>
                </div>
