      ...
      <div className="lg:container mx-auto px-4">
        ...
        <div className="deals_wrapper max-w-[600px]">
            ...
            <p className="text-base text-[#8a8a8a] font-poppins font-normal mb-10 max-w-[444px] w-full h-auto">
              Get ready for unbeatable discounts on top tech products! Save up to 50% on laptops, 
              smartphones, and accessories. Limited stock available - grab yours before time runs out!
            </p>
            <Link 
              to={'/products'} 
            ...
            <div className="mt-10">
              ...
              <div className="flex items-center gap-8 cursor-pointer">
                ...
                <div className="days flex flex-col gap-2.5 items-center justify-center">
                  ...
                  <p className="text-[22px] text-[#484848] font-poppins capitalize font-normal">Days</p>
                </div>
                ...
                <div className="hr flex flex-col gap-2.5 items-center justify-center">
                  ...
                  <p className="text-[22px] text-[#484848] font-poppins capitalize font-normal">hours</p>
                </div>
                ...
                <div className="mins flex flex-col gap-2.5 items-center justify-center">
                  ...
                  <p className="text-[22px] text-[#484848] font-poppins capitalize font-normal">minutes</p>
                </div>
                ...
                <div className="secs flex flex-col gap-2.5 items-center justify-center">
                  ...
                  <p className="text-[22px] text-[#484848] font-poppins capitalize font-normal">seconds</p>
                </div>
              </div>
            </div>
        </div>
